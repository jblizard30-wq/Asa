  ...
  return (
    <div className="fixed inset-0 z-30 flex items-center justify-center bg-slate-900/40 p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="mt-4 inline-flex rounded-md border border-slate-200 p-1 dark:border-slate-700">
          <button
            type="button"
        ...
        <div className="mt-4 space-y-4">
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 dark:border-slate-700 dark:bg-slate-800"
            />
          </div>
