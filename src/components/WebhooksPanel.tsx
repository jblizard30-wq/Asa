    ...
    <div>
      <div className="space-y-2">
        <input
          ...
          className="w-full rounded-md border border-slate-200 px-3 py-2 text-sm focus:border-brand-400 focus:outline-none focus:ring-1 focus:ring-brand-400 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-100"
        />
      ...
      <div className="mt-4 space-y-2">
        ...
        {initialWebhooks.map((webhook) => (
          <div
            key={webhook.id}
            className="rounded-md border border-slate-200 px-3 py-2 text-sm dark:border-slate-600"
          >
